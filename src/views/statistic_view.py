        ...
        for i, entity in enumerate(top_entities):
            ...
            bottom_axis_labels.append(
                ft.ChartAxisLabel(
                    value=i, 
                    label=ft.Container(
                        ft.Text(entity.name, size=8, text_align=ft.TextAlign.CENTER), 
                        padding=2
                    )
                )
            )

        max_y = max([e.cases_count for e in top_entities]) + 5 if top_entities else 10
            ...
            ft.Row(
                [
                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ft.Text("Case Statistics", size=20, weight=ft.FontWeight.BOLD),
                                ft.Text("Top 10 Victims by Case Involvement", size=14),
                                victims_chart,
                                ft.Text("Top 10 Suspects by Case Involvement", size=14),
                                suspects_chart
                            ],
